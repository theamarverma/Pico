  ...
  return (
    <>
      ...
      <footer className="hidden bg-bgGray md:block">
        <div className="flex flex-col items-center justify-center gap-10 px-4 pt-10 md:flex-row md:items-start md:px-20">
          <div>
            <Image
          ...
          <div className="flex-grow leading-[38px] text-[#6B6B6B] md:w-[20%]">
